...
def train_dfa(X, Y, num_feats, num_pdfs):
    ...
    # -------- LOGGING --------
   # raw_weight_logger = RawWeightLogger(f"../results/DFA_V2_raw_weights_{num_pdfs}.txt")
    stats_logger = WeightStatisticsLogger(f"../results/weights/DFA_V2_weight_stats_{num_pdfs}.txt")
